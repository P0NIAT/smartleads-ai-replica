...
const Footer: React.FC = () => {
  ...
  return (
    <footer id="contact" className="bg-gradient-to-br from-beauty-purple to-beauty-pink text-white py-16">
      <div className="safe-zone">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          {Object.entries(links).map(([category, items]) => (
            <div key={category}>
              <h4 className="font-montserrat font-bold text-lg mb-6 text-beauty-lavender">
                {category}
              </h4>
              <ul className="space-y-3">
                {items.map((item) => (
                  <li key={item}>
                    <a 
                      href="#" 
                      className="text-gray-200 hover:text-beauty-lavender transition-colors duration-300"
                    >
                      {item}
                    </a>
                  </li>
